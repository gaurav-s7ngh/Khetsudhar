...
const SustainabilityGauge = ({
  ...
  const getScoreConfig = (s: string) => {
    ...
    switch (normalized) {
      case "HIGH":
        return { value: 90, color: "#4CAF50", label: "EXCELLENT" };
      case "MEDIUM":
        return { value: 60, color: "#FFC107", label: "GOOD" };
      case "LOW":
        return { value: 30, color: "#FF5252", label: "CRITICAL" };
      default:
        return { value: 10, color: "#FF5252", label: "UNKNOWN" };
    }
  };
  ...
  React.useEffect(() => {
    progress.value = withTiming(config.value, {
      duration: 1500,
  ...
  return (
    <View style={styles.gaugeWrapper}>
      ...
      <View style={[styles.gaugeLabelContainer, { borderColor: config.color }]}>
        <Text style={[styles.gaugeLabelText, { color: config.color }]}>
          {config.label}
        </Text>
      </View>
    </View>
...
export default function ProfileScreen() {
  ...
  if (!profile) {
    return (
      <View style={styles.loadingContainer}>
        <Text
          style={{ color: "white", marginBottom: 20, fontFamily: PIXEL_FONT }}
        >
          GUEST MODE
        </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.gaugeCard}>
            ...
            <Text style={styles.gaugeTip}>
              Keep using organic fertilizers to boost your score!
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <View style={[styles.achievementBadge, styles.achievementLocked]}>
              ...
              <Text style={styles.achievementTextLocked}>More Soon</Text>
            </View>
          </ScrollView>
        </View>
